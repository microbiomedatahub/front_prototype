      ...
      <div className='container-fluid'>
        ...
        <div className='row'>
          <div className='col-sm-8 col-sm-offset-2'>
            <blockquote className='lead'>Japanese gut microbiome database of the Cross-ministerial Strategic Innovation Promotion Program (SIP) "Technologies for Smart Bio-industry and Agriculture" project.</blockquote>
