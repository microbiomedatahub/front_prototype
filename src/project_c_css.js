//import './application_c.scss'

function ProjectCCss() {
    let background_color = "#00EEAA";
    ...
    let logo_image = "url(/images/project_c.png)";
    let nav_image_height = "60px";
